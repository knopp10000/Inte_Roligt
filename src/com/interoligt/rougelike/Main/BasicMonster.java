...
public class BasicMonster extends Monster {
    ...
    public BasicMonster(String name, int level, int expPerLevel, Element element, int baseHealth, int baseArmour, int baseDamage, int baseSpeed) throws IllegalArgumentException{
